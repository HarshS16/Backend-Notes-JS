// In backend developement we need to master 2 things: one is a programming language which in our case is javascript and the other is database which could me sql, mongodb, nosql, postgresql.
